...
# Function load is a custom function created to load specified or default URL.
...
function validate( $link, $email = '', $pwd = '')
{
  ...
  /*In PHP, the trim() function is used to remove whitespace or other specified characters from both the beginning and the end of a string. 
